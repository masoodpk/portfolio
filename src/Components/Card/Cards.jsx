...
function Card(props) {
  ...
  return (
    <div className='card-container duration-300  flex  shadow-lg max-sm:shadow-neutral-300 shadow-neutral-700 ml-[25px] mt-[50px] mb-[20px] rounded-2xl  ' data-aos = 'fade-right'>

      
      <div className="card-body relative   group  bg-slate-100 w-[360px]  sm:h-60 rounded-xl  flex flex-col overflow-hidden duration-500  ">
